...
config :barragenspt, BarragensptWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "5Ip8FDtzBpEvx7fgxY1xhKle0Hmnutz0/MTNDdBRdi3XAIrhCVUxcedgc0rnUWDB",
  watchers: [
...
config :barragenspt, BarragensptWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/barragenspt_web/(live|views)/.*(ex)$",
      ~r"lib/barragenspt_web/templates/.*(eex)$"
    ]
  ]
