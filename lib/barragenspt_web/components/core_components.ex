defmodule BarragensptWeb.CoreComponents do
  ...
  attr :padding, :string,
    default: "pb-4",
    doc: "Tailwind padding-bottom below the title (e.g. pb-2)."
  ...
  def icon(%{name: "hero-chart-bar"} = assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  def icon(%{name: "hero-sparkles"} = assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  def icon(%{name: "hero-bell-alert"} = assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  def icon(%{name: "hero-lock-closed"} = assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
