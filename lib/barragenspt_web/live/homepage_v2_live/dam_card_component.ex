      ...
      <div class="w-full bg-slate-100/80 dark:bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-float border border-slate-200/50 dark:border-slate-600/60 overflow-hidden text-[13px] text-slate-800 dark:text-slate-200">
        ...
        <div class="p-3 space-y-2 text-sm text-slate-600 dark:text-slate-300">
          ...
          >
            ...
            <div class="h-52 rounded-lg bg-white/90 dark:bg-slate-700/80 border border-slate-200/80 dark:border-slate-600 overflow-hidden">
          ...
          >
            ...
            <div phx-update="ignore" id="dam-realtime-chart-container">
              <div
                class="h-52 rounded-lg bg-white/90 dark:bg-slate-700/80 border border-slate-200/80 dark:border-slate-600 overflow-hidden"
              >
