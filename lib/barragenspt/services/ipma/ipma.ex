defmodule Barragenspt.Services.Ipma do
  ...
  defp get_internal(indicator, year, month, format, layer) do
    ...
    url =
      "#{base_url}?service=WMS&request=GetMap&layers=#{layer}&styles&format=#{format}&transparent=true&version=1.1.1&time=#{year}-#{month}-01T00%3A00%3A00Z&width=280&height=450&srs=EPSG%3A3857&bbox=-1094009.7446,4438339.9340,-689199.2428,5212494.1564"
  ...
  defp get_internal(indicator, year, month, day, format, layer) do
    ...
    url =
      "#{base_url}?service=WMS&request=GetMap&layers=#{layer}&styles&format=#{format}&transparent=true&version=1.1.1&time=#{year}-#{month}-#{day}T00%3A00%3A00Z&width=280&height=450&srs=EPSG%3A3857&bbox=-1094009.7446,4438339.9340,-689199.2428,5212494.1564"
