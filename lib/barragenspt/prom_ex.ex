defmodule Barragenspt.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule BarragensptWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :barragenspt
  ...
  use PromEx, otp_app: :barragenspt
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: BarragensptWeb.Router, endpoint: BarragensptWeb.Endpoint},
      Plugins.Ecto,
      Plugins.Oban,
      ...
      # Barragenspt.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:barragenspt, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
